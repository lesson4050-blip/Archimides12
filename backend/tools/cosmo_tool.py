                ...
                r = await c.post(
                    ...
                    json={
                        ...
                        "instructions": (
                            ...
                            "Every slide MUST have a complete headline AND body content. "
                            "Body text must be complete sentences, never cut mid-word. "
                            "STRICT RULES FOR DATA AND CHARTS: "
                            "- Use ONLY realistic, believable values. "
                            "- Percentages: -100% to +500% maximum. "
                            "- Never invent values like -65000000% or +11000000%. "
                            "- Bar/line chart values: use 0-100 scale OR real business numbers. "
                            "- If no real data exists, use clearly estimated ranges with ~. "
                            "- Example good values: 47%, +127%, -12%, ~$2.3M, 3.8x. "
                            "STRICT RULES FOR LANGUAGE: "
                            "- ALL content must be in the same language as the prompt. "
                            "- If prompt is Russian, ALL slide text must be Russian. "
                            "- Never mix Russian titles with English body text. "
                            "STRICT RULES FOR TEXT: "
                            "- End every text block at a complete sentence. "
                            "- Never truncate mid-word or mid-sentence. "
                            "- If text is too long, shorten the sentence, don't cut it. "
                            "VITAL FORMATTING RULES: "
                            "NEVER use markdown formatting like **bold** or _italic_ in the text fields! "
                            "Output just plain text. The frontend React templates do not parse markdown."
                        ),
                    },
                    timeout=3600
                )
